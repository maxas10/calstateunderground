...
export default function Page() {
  ...
  return <div className="flex flex-col gap-10 pt-[2vh] pb-[2vh]" id="about-container">
    <p className="text-2xl">about</p>
    <p>We are an indie rock band formed in 2024. We are currently working on our first album.</p>

    <p className="text-2xl">members</p>
    <Link href="https://www.instagram.com/pear.hyunoo/">Hyunhoo (no gf guitarist)</Link>
    <Link href="https://www.instagram.com/joshuanguyen857/">Joshua (unc guitarist)</Link>
    <Link href="https://www.instagram.com/ryannnn.__09/">Ryan (freaky pianist)</Link>
    <Link href="https://www.instagram.com/rrrrronnie_/">Ronnie (beloved drummer)</Link>
    <Link href="https://www.instagram.com/yun_ho.06/">Yunho (bassist)</Link>
    <Link href="https://www.instagram.com/adrianlee0/">Adrian (producer)</Link>
    <Link href="https://www.instagram.com/maxseun/">Max (cameraman/website)</Link>
    {/* <Image src="/tidalwaves.jpg" alt="" className="top-10 bobbing-image shadow-xl" ></Image> */}
  </div>
}